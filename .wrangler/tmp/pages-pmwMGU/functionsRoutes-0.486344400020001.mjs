...
import { onRequestGet as __api_offers_admantum_feed_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\admantum-feed.js"
import { onRequestGet as __api_offers_admantum_postback_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\admantum-postback.js"
import { onRequestPost as __api_offers_admantum_postback_js_onRequestPost } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\admantum-postback.js"
...
import { onRequestGet as __api_offers_paidbucksy_postback_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\paidbucksy-postback.js"
import { onRequestPost as __api_offers_paidbucksy_postback_js_onRequestPost } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\paidbucksy-postback.js"
import { onRequestGet as __api_offers_radientwall_postback_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\radientwall-postback.js"
import { onRequestPost as __api_offers_radientwall_postback_js_onRequestPost } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\radientwall-postback.js"
import { onRequestGet as __api_offers_revtoo_feed_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\revtoo-feed.js"
import { onRequestGet as __api_offers_revtoo_postback_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\revtoo-postback.js"
import { onRequestPost as __api_offers_revtoo_postback_js_onRequestPost } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\revtoo-postback.js"
import { onRequestGet as __api_offers_taskwall_feed_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\taskwall-feed.js"
import { onRequestGet as __api_offers_taskwall_postback_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\taskwall-postback.js"
import { onRequestPost as __api_offers_taskwall_postback_js_onRequestPost } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\taskwall-postback.js"
import { onRequestGet as __api_offers_vortexwall_postback_js_onRequestGet } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\vortexwall-postback.js"
import { onRequestPost as __api_offers_vortexwall_postback_js_onRequestPost } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\vortexwall-postback.js"
...
import { onRequest as __api_offers_primewall_postback_js_onRequest } from "C:\\Users\\AC\\OneDrive\\Documents\\incm website\\functions\\api\\offers\\primewall-postback.js"
...
export const routes = [
  ...
  {
      routePath: "/api/offers/admantum-feed",
      mountPath: "/api/offers",
      method: "GET",
      middlewares: [],
      modules: [__api_offers_admantum_feed_js_onRequestGet],
    },
  {
      routePath: "/api/offers/admantum-postback",
      mountPath: "/api/offers",
      method: "GET",
      middlewares: [],
      modules: [__api_offers_admantum_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/admantum-postback",
      mountPath: "/api/offers",
      method: "POST",
      middlewares: [],
      modules: [__api_offers_admantum_postback_js_onRequestPost],
    },
  {
      routePath: "/api/offers/cpalead-postback",
      mountPath: "/api/offers",
      method: "GET",
      middlewares: [],
      modules: [__api_offers_cpalead_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/cpalead-postback",
      mountPath: "/api/offers",
      method: "POST",
      middlewares: [],
      modules: [__api_offers_cpalead_postback_js_onRequestPost],
    },
  {
      routePath: "/api/offers/earnings",
      mountPath: "/api/offers",
      method: "GET",
      middlewares: [],
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_gemiad_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/gemiad-postback",
      mountPath: "/api/offers",
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_paidbucksy_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/paidbucksy-postback",
      mountPath: "/api/offers",
      method: "POST",
      middlewares: [],
      modules: [__api_offers_paidbucksy_postback_js_onRequestPost],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_radientwall_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/radientwall-postback",
      mountPath: "/api/offers",
      method: "POST",
      middlewares: [],
      modules: [__api_offers_radientwall_postback_js_onRequestPost],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_revtoo_feed_js_onRequestGet],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_revtoo_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/revtoo-postback",
      mountPath: "/api/offers",
      method: "POST",
      middlewares: [],
      modules: [__api_offers_revtoo_postback_js_onRequestPost],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_taskwall_feed_js_onRequestGet],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_taskwall_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/taskwall-postback",
      mountPath: "/api/offers",
      method: "POST",
      middlewares: [],
      modules: [__api_offers_taskwall_postback_js_onRequestPost],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_offers_vortexwall_postback_js_onRequestGet],
    },
  {
      routePath: "/api/offers/vortexwall-postback",
      mountPath: "/api/offers",
      method: "POST",
      middlewares: [],
      modules: [__api_offers_vortexwall_postback_js_onRequestPost],
    },
  {
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_offers_primewall_postback_js_onRequest],
    },
  {
